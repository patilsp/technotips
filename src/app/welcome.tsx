...
export default function Welcome() {
  return (
    ...
    <motion.div
      ...
      >
      <section className="w-full bg-[#17181C] text-white">

        <div className="container space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
        <div className=" border border-gray-700 rounded-lg py-2 px-4 text-gray-400 text-sm mb-5 transition duration-300 ease-in-out hover:text-gray-300">Over 1K people have become part of our community 🎉</div>
          <h1 className="font-heading text-white text-3xl sm:text-5xl md:text-6xl lg:text-7xl">
            Welcome to <br />   <p className="h2 text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200" >TechnoTips </p>
          </h1>
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
          TechnoTips: A network of diverse communities to explore your interests, hobbies, and passions. Discover the perfect community for your unique interests!
          </p>
          ...
          <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
            <div className="flex flex-col justify-center space-y-8 text-center">
              <div className="space-y-2">
                <h2 className="h2 text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-500">
        ...
        <div className="grid gap-6">
          ...
          <ul className="grid gap-3 text-sm text-muted-foreground sm:grid-cols-2">
            <li className="flex items-center">
              <CheckCircle className="mr-2 h-4 w-4" /> Unlimited Posts
            </li>
            <li className="flex items-center">
              <CheckCircle className="mr-2 h-4 w-4" /> Unlimited Users
            </li>

            <li className="flex items-center">
              <CheckCircle className="mr-2 h-4 w-4" /> Custom domain
            </li>
            <li className="flex items-center">
              <CheckCircle className="mr-2 h-4 w-4" /> Dashboard Analytics
            </li>
            <li className="flex items-center">
              <CheckCircle className="mr-2 h-4 w-4" /> Access to Discord
            </li>
            <li className="flex items-center">
              <CheckCircle className="mr-2 h-4 w-4" /> Premium Support
            </li>
          </ul>
        </div>
      ...
      <div className="mx-auto flex w-full max-w-[58rem] flex-col gap-4">
            ...
            <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
                <div className="grid gap-6 items-center">
                    <div className="flex flex-col justify-center space-y-4 text-center">
                        <div className="space-y-2">
                            <h2 className="h2 text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-500 mb-4">
                                Subscribe To Our Newsletter
                            </h2>
                            <p className="max-w-[600px] text-zinc-200 md:text-xl dark:text-zinc-100 mx-auto mb-4">
                            Join us and take control of your inbox. Fast, secure, and designed for modern life.
                            </p>
                        </div>
                        <div className="w-full max-w-sm space-y-2 mx-auto mb-4">
                            ...
                            <Input
                                ...
                                type="email"
                            />
                            <Button className="bg-white text-black hover:text-white hover:border" href="/sign-in">
                                Join Now
                            </Button>
                            </form>
                            <p className="text-xs text-zinc-200 dark:text-zinc-100 mt-2">
                            Get ready to redefine your email experience.
                            <Link className="underline underline-offset-2 text-white " href="/sign-in">
                                Terms & Conditions
                            </Link>
                            </p>
                        </div>
        ...
        <div id="open-source" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          <h2 className="h2 text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-500">
            Proudly Open Source
          </h2>
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
              TechnoTips is committed to open-source principles. Our code is available on{" "}
            <Link
              href={siteConfig.links.github}
              target="_blank"
              rel="noreferrer"
            ...
            >
              ...
              <div className="flex items-center">
                ...
                <div className="flex h-10 items-center rounded-md border border-muted text-black bg-muted px-4 font-medium">
                  2K stars on GitHub
                </div>
              </div>
            </Link>
